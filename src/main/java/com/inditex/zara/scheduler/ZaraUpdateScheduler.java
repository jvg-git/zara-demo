...
public class ZaraUpdateScheduler {
	...
	@PostConstruct
	public void init() {
		logger.info("Using Spring Scheduler...");
	}
	...
	public JobDetailFactoryBean jobDetail() {
		...
		jobDetailFactory.setJobClass(UpdateJob.class);
		jobDetailFactory.setName("Zara_Update_Job_Detail");
		jobDetailFactory.setDescription("Invoke Update Job service...");
