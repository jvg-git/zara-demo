...
import com.inditex.zara.services.sync.PriceService;

@RestController
@RequestMapping("/api/prices/sync")
public class PriceRequestEndpointSync {

	private static Logger logger = LoggerFactory.getLogger(PriceRequestEndpointSync.class);
